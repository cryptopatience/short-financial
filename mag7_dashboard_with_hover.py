...
with tab2:
    ...
    # 호버 텍스트가 있는 제목
    st.markdown("""
    <h3>📊 <span class="tooltip">상세 비교 차트
      <span class="tooltiptext">
        <strong>📊 차트별 상세 해석 가이드</strong><br><br>
        
        <strong>📈 차트 A: YF Short % of Float (공매도 비율)</strong><br>
        • <span style="color:#4CAF50;">초록색</span>: 2% 미만 - 매우 건강한 상태, 시장의 강한 신뢰<br>
        • <span style="color:#FF9800;">주황색</span>: 2-5% - 정상 범위, 일반적인 수준<br>
        • <span style="color:#F44336;">빨간색</span>: 5% 이상 - 공매도 압력 존재, 주의 필요<br>
        → 낮을수록 좋음. 5% 미만 권장<br><br>
        
        <strong>📅 차트 B: Days to Cover (청산 소요일)</strong><br>
        • <span style="color:#4CAF50;">초록색</span>: 2일 미만 - 빠른 청산 가능, 안정적<br>
        • <span style="color:#FF9800;">주황색</span>: 2-3일 - 보통 수준<br>
        • <span style="color:#F44336;">빨간색</span>: 3일 이상 - Short Squeeze 가능성 존재<br>
        → 공매도 잔고를 일평균 거래량으로 나눈 값<br>
        → 3일 이상이면 변동성 증가 가능<br><br>
        
        <strong>📊 차트 C: Shares Short (공매도 주식 수)</strong><br>
        • 절대적인 공매도 규모를 나타냄<br>
        • 클수록 변동성 증가 가능<br>
        • 색상 진할수록 공매도 규모 큼<br>
        → 백만 주 단위로 표시<br><br>
        
        <strong>📉 차트 D: 전월 대비 변화율</strong><br>
        • <span style="color:#F44336;">빨간색(+)</span>: 공매도 증가 = 약세 신호<br>
        • <span style="color:#4CAF50;">초록색(-)</span>: 공매도 감소 = 강세 신호<br>
        → 0선 기준으로 증감 파악<br>
        → 급격한 증가는 주의 신호<br><br>
        
        <strong>📊 차트 E: FINRA Daily Short %</strong><br>
        • <span style="color:#4CAF50;">초록색</span>: 35% 미만 - 낮은 공매도 거래<br>
        • <span style="color:#FF9800;">주황색</span>: 35-45% - 정상 범위<br>
        • <span style="color:#F44336;">빨간색</span>: 45% 이상 - 공매도 거래 활발<br>
        → 전체 거래량 중 공매도가 차지하는 비중<br>
        → 30-40%는 정상적인 수준<br><br>
        
        <strong>📊 차트 F: FINRA 10일 평균 vs 최근일</strong><br>
        • <span style="color:#64B5F6;">하늘색</span>: 10일 평균<br>
        • <span style="color:#1976D2;">진한 파란색</span>: 최근일<br>
        → 최근일 > 평균: 공매도 증가 추세 (약세)<br>
        → 최근일 < 평균: 공매도 감소 추세 (강세)<br>
        → 추세 변화 파악에 유용
      </span>
    </span></h3>
    """, unsafe_allow_html=True)
...
st.markdown(
    ...
    "<p>📊 MAG 7+2 종합 분석 대시보드 v3.1 (Complete Edition with Hover Tooltips)</p>"
